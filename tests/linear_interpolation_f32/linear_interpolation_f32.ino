...
* --------------------------------------------------------------------*/
float testInputSin_f32[TEST_LENGTH_SAMPLES] =
{
...
*------------------------------------------------------------------------------*/
float testRefSinOutput32_f32[TEST_LENGTH_SAMPLES] =
{
...
*------------------------------------------------------------------------------*/
float testOutput[TEST_LENGTH_SAMPLES];

/*------------------------------------------------------------------------------
*  Method 2: Test out buffer Calculated from Linear Interpolation
*------------------------------------------------------------------------------*/
float testLinIntOutput[TEST_LENGTH_SAMPLES];
...
void setup()
{
  ...
  float snr1;
  float snr2;
  arm_linear_interp_instance_f32 S = {188495, -3.141592653589793238,
    XSPACING, (float *)&arm_linear_interep_table[0]};

  Serial.begin(9600);
  while(!Serial);
  delay(200);
  Serial.println("Linear interpolation Test");
