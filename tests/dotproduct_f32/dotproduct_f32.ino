...
** ------------------------------------------------------------------- */
float srcA_buf_f32[MAX_BLOCKSIZE] =
{
...
** ------------------------------------------------------------------- */
float srcB_buf_f32[MAX_BLOCKSIZE] =
{
...
float  refDotProdOut = 5.9273644806352142;

/* ----------------------------------------------------------------------
* Declare Global variables
* ------------------------------------------------------------------- */
float multOutput[MAX_BLOCKSIZE];  /* Intermediate output */
float testOutput;  /* Final ouput */

void setup(void)
{
	uint32_t i;
	float diff;	 /* Difference between reference and test outputs */

	Serial.begin(9600);
	while(!Serial); // wait for Arduino serial monitor
	delay(100);
	Serial.println("Test computing dot product of two vectors");
